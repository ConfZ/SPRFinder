...
import numpy as np
import settings
from smtlib.script import SMTLIBScript, print_sexp
    ...
    def mk_auxilary(self):
        ...
        for c in self.funcs:
            ...
            if settings.ConstRestrictRange_m1_p1:
                self.mk_assert(
                    self.mk_and(self.mk_fp_lt(c, self.mk_literal("0", "01111111", "00000000000000000000000")),
                                self.mk_fp_gt(c, self.mk_literal("1", "01111111", "00000000000000000000000"))))
