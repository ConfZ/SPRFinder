...
from SMT_generator.constants import *
...
def make_gte(s, w):         return Token('GTE',         w,       s.match.start())
def make_lte(s, w):         return Token('LTE',         w,       s.match.start())
def make_equal(s, w):      return Token('EQUAL',      w,       s.match.start())
def make_plus(s, w):       return Token('ADD',        w,       s.match.start())
def make_minus(s, w):      return Token('MINUS',      w,       s.match.start())
def make_multi(s, w):      return Token('MULTI',      w,       s.match.start())
def make_div(s, w):        return Token('DIV',        w,       s.match.start())
def make_gt(s, w):         return Token('GT',         w,       s.match.start())
def make_lt(s, w):         return Token('LT',         w,       s.match.start())
...
SMT_20_TOKENS = [
    ...
    (r'declare-const',    make_declare_const),
    (r'define-const',     make_define_fun),
